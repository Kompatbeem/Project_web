                    ...
                    <div class="card bg-light d-flex flex-fill">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    ...
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Email: <?php echo $row['u_email'] ?></li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: <?php echo $row['u_tel'] ?></li>
                                    </ul>
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="text-right">
                                ...
                                <a href="case_give_work_db.php?tec_id=<?php echo $row['user_id']; ?>&case_id=<?php echo $case_id; ?>" class="btn btn-sm btn-primary">
